...
/**
 * Потолок высоты полотна там, где карточка на экране одна: повторение и
 * просмотр набора. Значение общее, потому что это один и тот же объект на
 * двух экранах — разъехавшись, они дали бы «в просмотре карточка другого
 * размера, чем в повторении».
 */
export const CARD_MAX_HEIGHT = "58dvh";
