...
- **Узел дерева — либо набор, либо контейнер, и различает их один признак:** есть ли у него собственные карточки. Контейнер (есть подкатегории, своих карточек нет) живёт в Categories и не показывается в My flashcards — учить в нём нечего. Правило одно на все экраны: `isStudySet()` в `lib/knowledge-tree.ts`.
