...
- До миграции 0020 колонки рода нет, и он выводится по-старому из данных (`isStudySet()` в `lib/knowledge-tree.ts`). Приложение работает в обоих случаях, но новый код обязан читать род, а не догадываться.
