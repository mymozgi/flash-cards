...
- **Форма дерева закреплена триггером: Category → Topic → Flashcards.** Категория только на верхнем уровне, тема только внутри категории, карточка только в теме. Три уровня, не больше.
