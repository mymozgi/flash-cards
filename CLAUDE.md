...
- **Категория — это `topics`, и других таблиц под неё нет.** Раздел Knowledge, «Study sets» и повторение смотрят на одно дерево с разных сторон. Новую сущность под «категорию», «колоду» или «тему» не заводить.
